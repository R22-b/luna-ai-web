...
async function processYouTube(url, sessionId = null) {
...
async function feynmanExplain(topic, sessionId = null) {
...
async function generateFlashcards(topic, sessionId = null) {
  const result = await chat([{
    role: 'user',
...
async function generateQuiz(topic, sessionId = null) {
  const result = await chat([{
    role: 'user',
...
async function summarizeLink(url, sessionId = null) {
